! function (a) {
	var b, c, d = "hasOwnProperty",
		...
		i = function (a, d) {
			...
			var e, f = c,
				...
				o = b;
			b = a, c = 0;
			for (var p = 0, q = j.length; p < q; p++) "zIndex" in j[p] && (l.push(j[p].zIndex), j[p].zIndex < 0 && (m[j[p].zIndex] = j[p]));
			for (l.sort(g); l[k] < 0;)
	...
	i._events = h, i.listeners = function (a) {
		var b, c, d, f, g, i, j, k, l = a.split(e),
			m = h,
			n = [m],
			o = [];
		for (f = 0, g = l.length; f < g; f++) {
			for (k = [], i = 0, j = n.length; i < j; i++)
				for (m = n[i].n, c = [m[l[f]], m["*"]], d = 2; d--;)(b = c[d]) && (k.push(b), o = o.concat(b.f || []));
			n = k
		}
		return o
	}, i.on = function (a, b) {
		if (a = String(a), "function" != typeof b) return function () {};
		for (var c = a.split(e), d = h, g = 0, i = c.length; g < i; g++) d = d.n, d = d.hasOwnProperty(c[g]) && d[c[g]] || (d[c[g]] = {
			n: {}
		});
		...
		return b.split(e)
	}, i.off = i.unbind = function (a, b) {
		if (!a) return void(i._events = h = {
			n: {}
		});
		var c, f, g, j, k, l, m, n = a.split(e),
			o = [h];
		for (j = 0, k = n.length; j < k; j++)
			for (l = 0; l < o.length; l += g.length - 2) {
				if (g = [l, 1], c = o[l].n, "*" != n[j]) c[n[j]] && g.push(c[n[j]]);
				else
					for (f in c) c[d](f) && g.push(c[f]);
				o.splice.apply(o, g)
			}
		...
		return i.on(a, c)
	}, i.version = "0.4.2", i.toString = function () {
		return "You are running Eve 0.4.2"
	}, "undefined" != typeof module && module.exports ? module.exports = i : "undefined" != typeof define ? define("eve", [], function () {
		return i
	}) : a.eve = i
}(window || this),
function (a, b) {
	...
	function c(a) {
		...
		if (c.is(a, U)) return c._engine.create[D](c, a.splice(0, 3 + c.is(a[0], T))).add(a);
	...
	function j(a, b, c, d, e, f, g, h, j) {
		...
		for (var k = j / 2, l = [-.1252, .1252, -.3678, .3678, -.5873, .5873, -.7699, .7699, -.9041, .9041, -.9816, .9816], m = [.2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069, .1069, .0472, .0472], n = 0, o = 0; o < 12; o++) {
			var p = k * l[o] + k,
				q = i(p, a, c, e, g),
				r = i(p, b, d, f, h),
				s = q * q + r * r;
	...
	function k(a, b, c, d, e, f, g, h, i) {
		if (!(i < 0 || j(a, b, c, d, e, f, g, h) < i)) {
			var k, l = .5,
				m = 1 - l;
			for (k = j(a, b, c, d, e, f, g, h, m); Q(k - i) > .01;) l /= 2, m += (k < i ? 1 : -1) * l, k = j(a, b, c, d, e, f, g, h, m);
			return m
		}
	}
	...
	function m(a, b, d) {
		...
		for (var g = j.apply(0, a), h = j.apply(0, b), i = O(~~(g / 5), 1), k = O(~~(h / 5), 1), m = [], n = [], o = {}, p = d ? 0 : [], q = 0; q < i + 1; q++) {
		...
		for (q = 0; q < k + 1; q++) r = c.findDotsAtSegment.apply(c, b.concat(q / k)), n.push({
			x: r.x,
			y: r.y,
			t: q / k
		});
		for (q = 0; q < i; q++)
			for (var s = 0; s < k; s++) {
				...
				if (z) {
					...
					A >= 0 && A <= 1.001 && B >= 0 && B <= 1.001 && (d ? p++ : p.push({
						x: z.x,
						y: z.y,
						t1: P(A, 1),
						t2: P(B, 1)
	...
	function n(a, b, d) {
		...
		for (var e, f, g, h, i, j, k, l, n, o, p = d ? 0 : [], q = 0, r = a.length; q < r; q++) {
			var s = a[q];
				...
				for (var t = 0, u = b.length; t < u; t++) {
					...
					if ("M" == v[0]) g = k = v[1], h = l = v[2];
						...
						if (d) p += w;
							...
							for (var x = 0, y = w.length; x < y; x++) w[x].segment1 = q, w[x].segment2 = t, w[x].bez1 = n, w[x].bez2 = o;
							p = p.concat(w)
						}
					}
				}
	...
	function s(a, d, e, f, g, h) {
		...
		if (i) {
			if (j) j.initstatus = f, j.start = new Date - j.ms * f;
				...
				for (var y in i)
					if (i[z](y) && (ca[z](y) || d.paper.customAttributes[z](y))) switch (r[y] = d.attr(y), null == r[y] && (r[y] = ba[y]), s[y] = i[y], ca[y]) {
						case T:
							t[y] = (s[y] - r[y]) / p;
							break;
						case "colour":
						...
						case "path":
							var B = Ja(r[y], s[y]),
								C = B[1];
							for (r[y] = B[0], t[y] = [], v = 0, x = r[y].length; v < x; v++) {
								t[y][v] = [0];
								for (var D = 1, F = r[y][v].length; D < F; D++) t[y][v][D] = (C[v][D] - r[y][v][D]) / p
							}
							break;
						case "transform":
							var G = d._,
								H = Oa(G[y], s[y]);
							if (H)
								for (r[y] = H.from, s[y] = H.to, t[y] = [], t[y].real = !0, v = 0, x = r[y].length; v < x; v++)
									for (t[y][v] = [r[y][v][0]], D = 1, F = r[y][v].length; D < F; D++) t[y][v][D] = (s[y][v][D] - r[y][v][D]) / p;
							else {
								...
								r[y] = [K.a, K.b, K.c, K.d, K.e, K.f], Ma(L, s[y]), s[y] = L._.transform, t[y] = [(L.matrix.a - K.a) / p, (L.matrix.b - K.b) / p, (L.matrix.c - K.c) / p, (L.matrix.d - K.d) / p, (L.matrix.e - K.e) / p, (L.matrix.f - K.f) / p]
							}
							break;
						case "csv":
							var M = I(i[y])[J](w),
	...
	var u, v, w = /[, ]+/,
		...
		W = (c._ISURL = /^url\(['"]?(.+?)['"]?\)$/i, /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i),
		X = {
			NaN: 1,
			Infinity: 1,
			"-Infinity": 1
		...
		ja = (c._radial_gradient = /^r(?:\(([^,]+?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*([^\)]+?)\))?/, {}),
		ka = function (a, b) {
			return $(a) - $(b)
		},
		la = function () {},
	...
	if (c._g = A, c.type = A.win.SVGAngle || A.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML", "VML" == c.type) {
		var ra, sa = A.doc.createElement("div");
		if (sa.innerHTML = '<v:shape adj="1"/>', ra = sa.firstChild, ra.style.behavior = "url(#default#VML)", !ra || "object" != typeof ra.adj) return c.type = G;
		sa = null
	}
	c.svg = !(c.vml = "VML" == c.type), c._Paper = C, c.fn = v = C.prototype = c.prototype, c._id = 0, c._oid = 0, c.is = function (a, b) {
		return b = M.call(b), "finite" == b ? !X[z](+a) : "array" == b ? a instanceof Array : "null" == b && null === a || b == typeof a && null !== a || "object" == b && a === Object(a) || "array" == b && Array.isArray && Array.isArray(a) || V.call(a).slice(8, -1).toLowerCase() == b
	...
	var ta = function (a) {
			if (c.vml) {
				...
				h.title = "Raphaël Colour Picker", h.style.display = "none", A.doc.body.appendChild(h), ta = f(function (a) {
					return h.style.color = a, A.doc.defaultView.getComputedStyle(h, G).getPropertyValue("color")
				})
			}
			return ta(a)
		},
		...
		xa = function (a, b, d) {
			if (null == b && c.is(a, "object") && "r" in a && "g" in a && "b" in a && (d = a.b, b = a.g, a = a.r), null == b && c.is(a, "string")) {
				var e = c.getRGB(a);
				a = e.r, b = e.g, d = e.b
			}
	...
	c.color = function (a) {
		...
		return c.is(a, "object") && "h" in a && "s" in a && "b" in a ? (b = c.hsb2rgb(a), a.r = b.r, a.g = b.g, a.b = b.b, a.hex = b.hex) : c.is(a, "object") && "h" in a && "s" in a && "l" in a ? (b = c.hsl2rgb(a), a.r = b.r, a.g = b.g, a.b = b.b, a.hex = b.hex) : (c.is(a, "string") && (a = c.getRGB(a)), c.is(a, "object") && "r" in a && "g" in a && "b" in a ? (b = c.rgb2hsl(a), a.h = b.h, a.s = b.s, a.l = b.l, b = c.rgb2hsb(a), a.v = b.b) : (a = {
			hex: "none"
		}, a.r = a.g = a.b = a.h = a.s = a.v = a.l = -1)), a.toString = wa, a
	}, c.hsb2rgb = function (a, b, c, d) {
		this.is(a, "object") && "h" in a && "s" in a && "b" in a && (c = a.b, b = a.s, d = a.o, a = a.h), a *= 360;
		var e, f, g, h, i;
		return a = a % 360 / 60, i = c * b, h = i * (1 - Q(a % 2 - 1)), e = f = g = c - i, a = ~~a, e += [i, h, 0, 0, h, i][a], f += [h, i, i, h, 0, 0][a], g += [0, 0, h, i, i, h][a], ya(e, f, g, d)
	}, c.hsl2rgb = function (a, b, c, d) {
		this.is(a, "object") && "h" in a && "s" in a && "l" in a && (c = a.l, b = a.s, a = a.h), (a > 1 || b > 1 || c > 1) && (a /= 360, b /= 100, c /= 100), a *= 360;
		var e, f, g, h, i;
		return a = a % 360 / 60, i = 2 * b * (c < .5 ? c : 1 - c), h = i * (1 - Q(a % 2 - 1)), e = f = g = c - i / 2, a = ~~a, e += [i, h, 0, 0, h, i][a], f += [h, i, i, h, 0, 0][a], g += [0, 0, h, i, i, h][a], ya(e, f, g, d)
		...
		c = xa(a, b, c), a = c[0], b = c[1], c = c[2];
		var d, e, f, g, h, i;
		return g = O(a, b, c), h = P(a, b, c), i = g - h, d = 0 == i ? null : g == a ? (b - c) / i : g == b ? (c - a) / i + 2 : (a - b) / i + 4, d = (d + 360) % 6 * 60 / 360, f = (g + h) / 2, e = 0 == i ? 0 : f < .5 ? i / (2 * f) : i / (2 - 2 * f), {
			h: d,
			s: e,
			l: f,
			toString: va
	...
	c.getRGB = f(function (a) {
		...
		!(ea[z](a.toLowerCase().substring(0, 2)) || "#" == a.charAt()) && (a = ta(a));
		var b, d, e, f, h, i, j = a.match(W);
		return j ? (j[2] && (e = _(j[2].substring(5), 16), d = _(j[2].substring(3, 5), 16), b = _(j[2].substring(1, 3), 16)), j[3] && (e = _((h = j[3].charAt(3)) + h, 16), d = _((h = j[3].charAt(2)) + h, 16), b = _((h = j[3].charAt(1)) + h, 16)), j[4] && (i = j[4][J](da), b = $(i[0]), "%" == i[0].slice(-1) && (b *= 2.55), d = $(i[1]), "%" == i[1].slice(-1) && (d *= 2.55), e = $(i[2]), "%" == i[2].slice(-1) && (e *= 2.55), "rgba" == j[1].toLowerCase().slice(0, 4) && (f = $(i[3])), i[3] && "%" == i[3].slice(-1) && (f /= 100)), j[5] ? (i = j[5][J](da), b = $(i[0]), "%" == i[0].slice(-1) && (b *= 2.55), d = $(i[1]), "%" == i[1].slice(-1) && (d *= 2.55), e = $(i[2]), "%" == i[2].slice(-1) && (e *= 2.55), ("deg" == i[0].slice(-3) || "°" == i[0].slice(-1)) && (b /= 360), "hsba" == j[1].toLowerCase().slice(0, 4) && (f = $(i[3])), i[3] && "%" == i[3].slice(-1) && (f /= 100), c.hsb2rgb(b, d, e, f)) : j[6] ? (i = j[6][J](da), b = $(i[0]), "%" == i[0].slice(-1) && (b *= 2.55), d = $(i[1]), "%" == i[1].slice(-1) && (d *= 2.55), e = $(i[2]), "%" == i[2].slice(-1) && (e *= 2.55), ("deg" == i[0].slice(-3) || "°" == i[0].slice(-1)) && (b /= 360), "hsla" == j[1].toLowerCase().slice(0, 4) && (f = $(i[3])), i[3] && "%" == i[3].slice(-1) && (f /= 100), c.hsl2rgb(b, d, e, f)) : (j = {
			r: b,
			g: d,
			b: e,
			toString: g
		...
		var d = {
			...
			e = [];
		return c.is(a, U) && c.is(a[0], U) && (e = Ba(a)), e.length || I(a).replace(ga, function (a, b, c) {
			var f = [],
				g = b.toLowerCase();
		...
		}), e.toString = c._path2string, b.arr = Ba(e), e
	}, c.parseTransformString = f(function (a) {
		if (!a) return null;
		var b = [];
		return c.is(a, U) && c.is(a[0], U) && (b = Ba(a)), b.length || I(a).replace(ha, function (a, c, d) {
			var e = [];
			M.call(c);
	...
	var Aa = c.pathBBox = function (a) {
			...
			a = Ja(a);
			for (var c, e = 0, f = 0, g = [], h = [], i = 0, j = a.length; i < j; i++)
		...
		Ca = c._pathToRelative = function (a) {
			...
			return d.toString = c._path2string, b.rel = Ba(d), d
		},
		Da = c._pathToAbsolute = function (a) {
			var b = za(a);
			if (b.abs) return Ba(b.abs);
			if (c.is(a, U) && c.is(a && a[0], U) || (a = c.parsePathString(a)), !a || !a.length) return [["M", 0, 0]];
			var d = [],
				e = 0,
				f = 0,
				g = 0,
			...
			for (var k, l, m = 3 == a.length && "M" == a[0][0] && "R" == a[1][0].toUpperCase() && "Z" == a[2][0].toUpperCase(), n = j, o = a.length; n < o; n++) {
				if (d.push(k = []), l = a[n], l[0] != aa.call(l[0])) switch (k[0] = aa.call(l[0]), k[0]) {
						...
						case "H":
							...
							break;
						case "R":
							for (var p = [e, f][E](l.slice(1)), q = 2, r = p.length; q < r; q++) p[q] = +p[q] + e, p[++q] = +p[q] + f;
							d.pop(), d = d[E](h(p, m));
							break;
						case "M":
							g = +l[1] + e, i = +l[2] + f;
			...
			return d.toString = c._path2string, b.abs = Ba(d), d
		},
		Ea = function (a, b, c, d) {
			return [a, b, c, d, c, d]
		},
		Fa = function (a, b, c, d, e, f) {
			return [1 / 3 * a + 2 / 3 * c, 1 / 3 * b + 2 / 3 * d, 1 / 3 * e + 2 / 3 * c, 1 / 3 * f + 2 / 3 * d, e, f]
		},
		Ga = function (a, b, c, d, e, g, h, i, j, k) {
			...
			if (k) y = k[0], z = k[1], w = k[2], x = k[3];
				...
				y = a < w ? S - y : y, z = i < w ? S - z : z, y < 0 && (y = 2 * S + y), z < 0 && (z = 2 * S + z), h && y > z && (y -= 2 * S), !h && z > y && (z -= 2 * S)
			}
			var A = z - y;
			if (Q(A) > m) {
				var B = z,
					C = i,
					D = j;
				z = y + m * (h && z > y ? 1 : -1), i = w + c * N.cos(z), j = x + d * N.sin(z), o = Ga(i, j, c, d, e, 0, h, C, D, [z, B, w, x])
			}
			A = z - y;
			var F = N.cos(y),
				G = N.sin(y),
			...
			o = [P, R, T][E](o).join()[J](",");
			for (var U = [], V = 0, W = o.length; V < W; V++) U[V] = V % 2 ? p(o[V - 1], o[V], n).y : p(o[V], o[V + 1], n).x;
			return U
		},
		...
		Ja = c._path2curve = f(function (a, b) {
			var c = !b && za(a);
			if (!b && c.curve) return Ba(c.curve);
			for (var d = Da(a), e = b && Da(b), f = {
					x: 0,
					y: 0,
					bx: 0,
					by: 0,
					...
					switch (!(a[0] in f) && (b.qx = b.qy = null), a[0]) {
						...
						case "S":
							...
							break;
						case "T":
							"Q" == c || "T" == c ? (b.qx = 2 * b.x - b.qx, b.qy = 2 * b.y - b.qy) : (b.qx = b.x, b.qy = b.y), a = ["C"][E](Fa(b.x, b.y, b.qx, b.qy, a[1], a[2]));
							break;
						case "Q":
							b.qx = a[1], b.qy = a[2], a = ["C"][E](Fa(b.x, b.y, a[1], a[2], a[3], a[4]));
							break;
						case "L":
				...
				}, k = [], l = [], m = "", n = "", o = 0, p = O(d.length, e && e.length || 0); o < p; o++) {
		...
		Ka = (c._parseDots = f(function (a) {
			...
			for (d = 1, e = b.length - 1; d < e; d++)
				if (!b[d].offset) {
					for (var h = $(b[d - 1].offset || 0), i = 0, j = d + 1; j < e; j++)
						if (b[j].offset) {
							i = b[j].offset;
							break
						}
					i || (i = 100, j = e), i = $(i);
					for (var k = (i - h) / (j - d + 1); d < j; d++) h += k, b[d].offset = h + "%"
				}
			return b
		}), c._tear = function (a, b) {
			a == b.top && (b.top = a.prev), a == b.bottom && (b.bottom = a.next), a.next && (a.next.prev = a.prev), a.prev && (a.prev.next = a.next)
		}),
		La = (c._tofront = function (a, b) {
			b.top !== a && (Ka(a, b), a.next = null, a.prev = b.top, b.top.next = a, b.top = a)
		}, c._toback = function (a, b) {
			b.bottom !== a && (Ka(a, b), a.next = b.bottom, a.prev = null, b.bottom.prev = a, b.bottom = a)
		}, c._insertafter = function (a, b, c) {
			Ka(a, c), b == c.top && (c.top = a), b.next && (b.next.prev = a), a.next = b.next, a.prev = b, b.next = a
		}, c._insertbefore = function (a, b, c) {
			Ka(a, c), b == c.bottom && (c.bottom = a), b.prev && (b.prev.next = a), a.prev = b.prev, b.prev = a, a.next = b
		...
		Ma = (c.transformPath = function (a, b) {
			return qa(a, La(a, b))
		...
		Oa = c._equaliseTransform = function (a, b) {
			...
			for (var d, e, f, g, h = O(a.length, b.length), i = [], j = [], k = 0; k < h; k++) {
				if (f = a[k] || Na(b[k]), g = b[k] || Na(f), f[0] != g[0] || "r" == f[0].toLowerCase() && (f[2] != g[2] || f[3] != g[3]) || "s" == f[0].toLowerCase() && (f[3] != g[3] || f[4] != g[4])) return;
				for (i[k] = [], j[k] = [], d = 0, e = O(f.length, g.length); d < e; d++) d in f && (i[k][d] = f[d]), d in g && (j[k][d] = g[d])
			}
			return {
				from: i,
				to: j
	...
	c._getContainer = function (a, b, d, e) {
			var f;
			if (null != (f = null != e || c.is(a, "object") ? a : A.doc.getElementById(a))) return f.tagName ? null == b ? {
				container: f,
		...
		}, c.pathToRelative = Ca, c._engine = {}, c.path2curve = Ja, c.matrix = function (a, b, c, d, e, f) {
		...
		function (a) {
			...
			a.add = function (a, b, c, d, e, f) {
				var g, h, i, j, k = [[], [], []],
					...
					m = [[a, c, e], [b, d, f], [0, 0, 1]];
				for (a && a instanceof o && (m = [[a.a, a.c, a.e], [a.b, a.d, a.f], [0, 0, 1]]), g = 0; g < 3; g++)
					for (h = 0; h < 3; h++) {
				...
				var f = -e[0][1],
					g = e[1][1];
				return g < 0 ? (a.rotate = c.deg(N.acos(g)), f < 0 && (a.rotate = 360 - a.rotate)) : a.rotate = c.deg(N.asin(f)), a.isSimple = !(+a.shear.toFixed(9) || a.scalex.toFixed(9) != a.scaley.toFixed(9) && a.rotate), a.isSuperSimple = !+a.shear.toFixed(9) && a.scalex.toFixed(9) == a.scaley.toFixed(9) && !a.rotate, a.noRotation = !+a.shear.toFixed(9) && !a.rotate, a
	...
	var Pa = navigator.userAgent.match(/Version\/(.*?)\s/) || navigator.userAgent.match(/Chrome\/(\d+)/);
	"Apple Computer, Inc." == navigator.vendor && (Pa && Pa[1] < 4 || "iP" == navigator.platform.slice(0, 2)) || "Google Inc." == navigator.vendor && Pa && Pa[1] < 8 ? v.safari = function () {
	...
	for (var Qa = function () {
			...
			return A.doc.addEventListener ? function (a, b, c, d) {
				...
				if (a.addEventListener(b, e, !1), F && L[b]) {
					var f = function (b) {
						for (var e = Ua(b), f = b, g = 0, h = b.targetTouches && b.targetTouches.length; g < h; g++)
							if (b.targetTouches[g].target == a) {
								b = b.targetTouches[g], b.originalEvent = f, b.preventDefault = Ra, b.stopPropagation = Ta;
								break
							}
				...
				var e = function (a) {
					...
					var b = A.doc.documentElement.scrollTop || A.doc.body.scrollTop,
						...
						f = a.clientX + e,
						g = a.clientY + b;
					return a.preventDefault = a.preventDefault || Qa, a.stopPropagation = a.stopPropagation || Sa, c.call(d, a, f, g)
				};
	...
	Za.drag = function (a, d, e, f, g, h) {
		function i(i) {
			...
			this._drag.x = j + m, this._drag.y = k + l, !Wa.length && c.mousemove(Xa).mouseup(Ya), Wa.push({
				el: this,
				move_scope: f,
				start_scope: g,
				end_scope: h
	...
	v.getElementByPoint = function (a, b) {
		...
		var b = this._;
		return a ? (!b.dirty && b.bboxwt || (this.realPath = pa[this.type](this), b.bboxwt = Aa(this.realPath), b.bboxwt.toString = p, b.dirty = 0), b.bboxwt) : ((b.dirty || b.dirtyT || !b.bbox) && (!b.dirty && this.realPath || (b.bboxwt = 0, this.realPath = pa[this.type](this)), b.bbox = Aa(qa(this.realPath, this.matrix)), b.bbox.toString = p, b.dirty = b.dirtyT = 0), b.bbox)
	}, Za.clone = function () {
	...
	var bb = function (a, b, d, e, f, g, h, i, l) {
		...
		cb = function (a, b) {
			return function (d, e, f) {
				d = Ja(d);
				for (var g, h, i, j, k, l = "", m = {}, n = 0, o = 0, p = d.length; o < p; o++) {
	...
	c.getTotalLength = db, c.getPointAtLength = eb, c.getSubpath = function (a, b, c) {
		...
		var a = this.getPath();
		if (a) return this.node.getTotalLength ? this.node.getTotalLength() : db(a)
	...
	var gb = c.easing_formulas = {
		...
		elastic: function (a) {
			return a == !!a ? a : R(2, -10 * a) * N.sin(2 * S * (a - .075) / .3) + 1
		},
		bounce: function (a) {
			var b, c = 7.5625,
				d = 2.75;
			...
			for (var a = +new Date, d = 0; d < hb.length; d++) {
				...
				if (!e.el.removed && !e.paused) {
					var f, g, h = a - e.start,
						...
						o = {},
						p = {};
					if (e.initstatus ? (h = (e.initstatus * e.anim.top - e.prev) / (e.percent - e.prev) * i, e.status = e.initstatus, delete e.initstatus, e.stop && hb.splice(d--, 1)) : e.status = (e.prev + (e.percent - e.prev) * (h / i)) / e.anim.top, !(h < 0))
						if (h < i) {
							var q = j(h / i);
							for (var r in k)
								if (k[z](r)) {
									switch (ca[r]) {
										case T:
											...
											break;
										case "colour":
											f = "rgb(" + [kb(Z(k[r].r + q * i * l[r].r)), kb(Z(k[r].g + q * i * l[r].g)), kb(Z(k[r].b + q * i * l[r].b))].join(",") + ")";
											break;
										case "path":
											f = [];
											for (var t = 0, u = k[r].length; t < u; t++) {
												f[t] = [k[r][t][0]];
												for (var v = 1, w = k[r][t].length; v < w; v++) f[t][v] = +k[r][t][v] + q * i * l[r][t][v];
												f[t] = f[t].join(H)
											}
											f = f.join(H);
											break;
										case "transform":
											if (l[r].real)
												for (f = [], t = 0, u = k[r].length; t < u; t++)
													for (f[t] = [k[r][t][0]], v = 1, w = k[r][t].length; v < w; v++) f[t][v] = k[r][t][v] + q * i * l[r][t][v];
											else {
												var x = function (a) {
	...
	Za.animateWith = function (a, b, d, e, f, g) {
		...
		var f, g, h = {};
		for (g in a) a[z](g) && $(g) != g && $(g) + "%" != g && (f = !0, h[g] = a[g]);
		...
		for (var c = 0; c < hb.length; c++) hb[c].el.id != this.id || a && hb[c].anim != a || !1 !== b("raphael.anim.pause." + this.id, this, hb[c].anim) && (hb[c].paused = !0);
		return this
	}, Za.resume = function (a) {
		for (var c = 0; c < hb.length; c++)
			if (hb[c].el.id == this.id && (!a || hb[c].anim == a)) {
				var d = hb[c];
				!1 !== b("raphael.anim.resume." + this.id, this, d.anim) && (delete d.paused, this.status(d.anim, d.status))
			}
		return this
	}, Za.stop = function (a) {
		for (var c = 0; c < hb.length; c++) hb[c].el.id != this.id || a && hb[c].anim != a || !1 !== b("raphael.anim.stop." + this.id, this, hb[c].anim) && hb.splice(c--, 1);
		return this
	...
	var lb = function (a) {
			if (this.items = [], this.length = 0, this.type = "set", a)
				for (var b = 0, c = a.length; b < c; b++) !a[b] || a[b].constructor != Za.constructor && a[b].constructor != lb || (this[this.items.length] = this.items[this.items.length] = a[b], this.length++)
		},
		mb = lb.prototype;
	mb.push = function () {
		for (var a, b, c = 0, d = arguments.length; c < d; c++) !(a = arguments[c]) || a.constructor != Za.constructor && a.constructor != lb || (b = this.items.length, this[b] = this.items[b] = a, this.length++);
		return this
	}, mb.pop = function () {
	...
	return mb.attr = function (a, b) {
			if (a && c.is(a, U) && c.is(a[0], "object"))
				...
				for (var f = 0, g = this.items.length; f < g; f++) this.items[f].attr(a, b);
			return this
		}, mb.clear = function () {
			for (; this.length;) this.pop()
		}, mb.splice = function (a, b, c) {
			a = a < 0 ? O(this.length + a, 0) : a, b = O(0, P(this.length - a, b));
			var d, e = [],
				f = [],
				g = [];
			...
			var h = g.length;
			for (d = 0; d < h + e.length; d++) this.items[a + d] = this[a + d] = d < h ? g[d] : e[d - h];
			...
			if (e = e || "normal", d = d || "normal", b = +b || {
				...
				var i;
				if (f)
					for (var j = 0, k = f.length; j < k && (i = f[j], i.face["font-weight"] != b || i.face["font-style"] != d && i.face["font-style"] || i.face["font-stretch"] != e); j++);
				return i
			}
			...
			if (c.is(e, "string") && (e = this.getFont(e)), e) {
				...
				for (var o = e.face.bbox[J](w), p = +o[0], q = o[3] - o[1], r = 0, s = +o[1] + ("baseline" == g ? q + +e.face.descent : q / 2), t = 0, u = k.length; t < u; t++) {
			...
			if (c.is(a, "array"))
				for (var b, d = this.set(), e = 0, f = a.length; e < f; e++) b = a[e] || {}, x[z](b.type) && d.push(this[b.type]().attr(b));
			return d
		}, c.format = function (a, b) {
			var d = c.is(b, U) ? [0][E](b) : arguments;
			return a && c.is(a, "string") && d.length - 1 && (a = a.replace(y, function (a, b) {
		...
		}, c.st = mb, b.on("raphael.DOMload", function () {
			u = !0
		}),
		function (a, b, d) {
			function e() {
			...
			null == a.readyState && a.addEventListener && (a.addEventListener("DOMContentLoaded", d = function () {
				a.removeEventListener("DOMContentLoaded", d, !1), a.readyState = "complete"
			...
			if (c.svg) {
							...
							if (f[a](o)) {
								...
								switch (k[o] = p, o) {
									...
									case "target":
										...
										"target" == o ? y.setAttributeNS(n, "show", "blank" == p ? "new" : p) : y.setAttributeNS(n, o, p);
										break;
									case "cursor":
										i.style.cursor = p;
										break;
					...
					x = function (d, f) {
						if ("text" == d.type && (f[a]("text") || f[a]("font") || f[a]("font-size") || f[a]("x") || f[a]("y"))) {
							...
							if (f[a]("text")) {
								...
								for (var j, k = b(f.text).split("\n"), m = [], n = 0, o = k.length; n < o; n++) j = q("tspan"), n && q(j, {
									dy: 1.2 * i,
									x: g.x
								}), j.appendChild(c._g.doc.createTextNode(k[n])), h.appendChild(j), m[n] = j
							} else
								for (m = h.getElementsByTagName("tspan"), n = 0, o = m.length; n < o; n++) n ? q(m[n], {
									dy: 1.2 * i,
									x: g.x
								}) : q(m[0], {
									dy: 0
				...
				z.prototype = A, A.constructor = z, c._engine.path = function (a, b) {
					...
					if (null == d && c.is(b, "string")) {
						...
						for (var g = b.split(j), h = {}, i = 0, l = g.length; i < l; i++) b = g[i], b in this.attrs ? h[b] = this.attrs[b] : c.is(this.paper.customAttributes[b], "function") ? h[b] = this.paper.customAttributes[b].def : h[b] = c._availableAttrs[b];
						return l - 1 ? h : h[g[0]]
					}
					if (null == d && c.is(b, "array")) {
						for (h = {}, i = 0, l = b.length; i < l; i++) h[b[i]] = this.attr(b[i]);
						return h
					}
					if (null != d) {
						var m = {};
		...
		function () {
			if (c.vml) {
				var a = "hasOwnProperty",
					...
					p = / progid:\S+Blur\([^\)]+\)/g,
					q = /-?[^,\s-]+/g,
					r = "position:absolute;left:0;top:0;width:1px;height:1px;behavior:url(#default#VML)",
					s = 21600,
					t = {
						path: 1,
						rect: 1,
					...
					v = function (a) {
						...
						if (b(a).match(d) && (e = c._path2curve), d = /[clmz]/g, e == c._pathToAbsolute && !b(a).match(d)) {
							var g = b(a).replace(o, function (a, b, c) {
								...
								return c.replace(q, function (a) {
									e && 2 == d.length && (g += d + n["m" == b ? "l" : "L"], d = []), d.push(f(a * s))
								}), g + d
							});
							return g
						}
						...
						for (var k = 0, p = j.length; k < p; k++) {
							...
							for (var r = 1, t = h.length; r < t; r++) i += f(h[r] * s) + (r != t - 1 ? "," : m);
							g.push(i)
						}
						return g.join(l)
					},
					...
					x = function (a, b, c, d, e, f) {
						...
						if (m.visibility = "hidden", b && c) {
							if (k.coordsize = i(p) + l + i(q), m.rotation = f * (b * c < 0 ? -1 : 1), f) {
								var r = w(f, d, e);
								d = r.dx, e = r.dy
							}
							if (b < 0 && (o += "x"), c < 0 && (o += " y") && (n = -1), m.flip = o, k.coordorigin = d * -p + l + e * -q, j || g.fillsize) {
								var t = k.getElementsByTagName("fill");
								t = t && t[0], k.removeChild(t), j && (r = w(f, h.x(j[0], j[1]), h.y(j[0], j[1])), t.position = r.dx * n + l + r.dy * n), g.fillsize && (t.size = g.fillsize[0] * i(b) + l + g.fillsize[1] * i(c)), k.appendChild(t)
							}
				...
				var y = function (a, c, d) {
					...
					z = function (e, i) {
						...
						var k = e.node,
							n = e.attrs,
							o = k.style,
							p = t[e.type] && (i.x != n.x || i.y != n.y || i.width != n.width || i.height != n.height || i.cx != n.cx || i.cy != n.cy || i.rx != n.rx || i.ry != n.ry || i.r != n.r),
							q = u[e.type] && (n.cx != i.cx || n.cy != i.cy || n.r != i.r || n.rx != i.rx || n.ry != i.ry),
							r = e;
						for (var w in i) i[a](w) && (n[w] = i[w]);
						if (p && (n.path = c._getPath[e.type](e), e._.dirty = 1), i.href && (k.href = i.href), i.title && (k.title = i.title), i.target && (k.target = i.target), i.cursor && (o.cursor = i.cursor), "blur" in i && e.blur(i.blur), (i.path && "path" == e.type || p) && (k.path = v(~b(n.path).toLowerCase().indexOf("r") ? c._pathToAbsolute(n.path) : n.path), e._.dirty = 1, "image" == e.type && (e._.fillpos = [n.x, n.y], e._.fillsize = [n.width, n.height], x(e, 1, 1, 0, 0, 0))), "transform" in i && e.transform(i.transform), q) {
							var z = +n.cx,
								B = +n.cy,
								C = +n.rx || +n.r || 0,
								E = +n.ry || +n.r || 0;
							k.path = c.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x", f((z - C) * s), f((B - E) * s), f((z + C) * s), f((B + E) * s), f(z * s)), e._.dirty = 1
						}
						if ("clip-rect" in i) {
							...
							if (4 == F.length) {
								...
								var G = k.clipRect || c._g.doc.createElement("div"),
									H = G.style;
								H.clip = c.format("rect({1}px {2}px {3}px {0}px)", F), k.clipRect || (H.position = "absolute", H.top = 0, H.left = 0, H.width = e.paper.width + "px", H.height = e.paper.height + "px", k.parentNode.insertBefore(G, k), G.appendChild(k), k.clipRect = G)
							}
							i["clip-rect"] || k.clipRect && (k.clipRect.style.clip = "auto")
						}
						if (e.textpath) {
							var I = e.textpath.style;
							i.font && (I.font = i.font), i["font-family"] && (I.fontFamily = '"' + i["font-family"].split(",")[0].replace(/^['"]+|['"]+$/g, m) + '"'), i["font-size"] && (I.fontSize = i["font-size"]), i["font-weight"] && (I.fontWeight = i["font-weight"]), i["font-style"] && (I.fontStyle = i["font-style"])
						}
						if ("arrow-start" in i && y(r, i["arrow-start"]), "arrow-end" in i && y(r, i["arrow-end"], 1), null != i.opacity || null != i["stroke-width"] || null != i.fill || null != i.src || null != i.stroke || null != i["stroke-width"] || null != i["stroke-opacity"] || null != i["fill-opacity"] || null != i["stroke-dasharray"] || null != i["stroke-miterlimit"] || null != i["stroke-linejoin"] || null != i["stroke-linecap"]) {
							var J = k.getElementsByTagName("fill");
							if (J = J && J[0], !J && (J = D("fill")), "image" == e.type && i.src && (J.src = i.src), i.fill && (J.on = !0), null != J.on && "none" != i.fill && null !== i.fill || (J.on = !1), J.on && i.fill) {
								var K = b(i.fill).match(c._ISURL);
								if (K) {
									J.parentNode == k && k.removeChild(J), J.rotate = !0, J.src = K[1], J.type = "tile";
									var L = e.getBBox(1);
									J.position = L.x + l + L.y, e._.fillpos = [L.x, L.y], c._preload(K[1], function () {
										e._.fillsize = [this.offsetWidth, this.offsetHeight]
									})
								} else J.color = c.getRGB(i.fill).hex, J.src = m, J.type = "solid", c.getRGB(i.fill).error && (r.type in {
									circle: 1,
									ellipse: 1
								} || "r" != b(i.fill).charAt()) && A(r, i.fill, J) && (n.fill = "none", n.gradient = i.fill, J.rotate = !1)
							}
							if ("fill-opacity" in i || "opacity" in i) {
								var M = ((+n["fill-opacity"] + 1 || 2) - 1) * ((+n.opacity + 1 || 2) - 1) * ((+c.getRGB(i.fill).o + 1 || 2) - 1);
								M = h(g(M, 0), 1), J.opacity = M, J.src && (J.color = "none")
							}
							k.appendChild(J);
							var N = k.getElementsByTagName("stroke") && k.getElementsByTagName("stroke")[0],
								O = !1;
							!N && (O = N = D("stroke")), (i.stroke && "none" != i.stroke || i["stroke-width"] || null != i["stroke-opacity"] || i["stroke-dasharray"] || i["stroke-miterlimit"] || i["stroke-linejoin"] || i["stroke-linecap"]) && (N.on = !0), ("none" == i.stroke || null === i.stroke || null == N.on || 0 == i.stroke || 0 == i["stroke-width"]) && (N.on = !1);
							var P = c.getRGB(i.stroke);
							N.on && i.stroke && (N.color = P.hex), M = ((+n["stroke-opacity"] + 1 || 2) - 1) * ((+n.opacity + 1 || 2) - 1) * ((+P.o + 1 || 2) - 1);
							var Q = .75 * (d(i["stroke-width"]) || 1);
							if (M = h(g(M, 0), 1), null == i["stroke-width"] && (Q = n["stroke-width"]), i["stroke-width"] && (N.weight = Q), Q && Q < 1 && (M *= Q) && (N.weight = 1), N.opacity = M, i["stroke-linejoin"] && (N.joinstyle = i["stroke-linejoin"] || "miter"), N.miterlimit = i["stroke-miterlimit"] || 8, i["stroke-linecap"] && (N.endcap = "butt" == i["stroke-linecap"] ? "flat" : "square" == i["stroke-linecap"] ? "square" : "round"), "stroke-dasharray" in i) {
								var R = {
									"-": "shortdash",
									".": "shortdot",
									"-.": "shortdashdot",
								...
								N.dashstyle = R[a](i["stroke-dasharray"]) ? R[i["stroke-dasharray"]] : m
							}
							O && k.appendChild(N)
						}
						if ("text" == r.type) {
							...
							o = S.style, n.font && (o.font = n.font), n["font-family"] && (o.fontFamily = n["font-family"]), n["font-weight"] && (o.fontWeight = n["font-weight"]), n["font-style"] && (o.fontStyle = n["font-style"]), T = d(n["font-size"] || T && T[0]) || 10, o.fontSize = 100 * T + "px", r.textpath.string && (S.innerHTML = b(r.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;").replace(/\n/g, "<br>"));
							var U = S.getBoundingClientRect();
							r.W = n.w = (U.right - U.left) / 100, r.H = n.h = (U.bottom - U.top) / 100, r.X = n.x, r.Y = n.y + r.H / 2, ("x" in i || "y" in i) && (r.path.v = c.format("m{0},{1}l{2},{1}", f(n.x * s), f(n.y * s), f(n.x * s) + 1));
							for (var V = ["x", "y", "text", "font", "font-family", "font-weight", "font-style", "font-size"], W = 0, X = V.length; W < X; W++)
								if (V[W] in i) {
									r._.dirty = 1;
									break
								}
					...
					A = function (a, f, g) {
						...
						if (a.attrs.gradient = f, f = b(f).replace(c._radial_gradient, function (a, b, c) {
								return i = "radial", b && c && (b = d(b), c = d(c), h(b - .5, 2) + h(c - .5, 2) > .25 && (c = e.sqrt(.25 - h(b - .5, 2)) * (2 * (c > .5) - 1) + .5), j = b + l + c), m
						...
						if (a = a.shape || a.node, n.length) {
							a.removeChild(g), g.on = !0, g.method = "none", g.color = n[0].color, g.color2 = n[n.length - 1].color;
							for (var o = [], p = 0, q = n.length; p < q; p++) n[p].offset && o.push(n[p].offset + l + n[p].color);
							g.colors = o.length ? o.join() : "0% " + g.color, "radial" == i ? (g.type = "gradientTitle", g.focus = "100%", g.focussize = "0 0", g.focusposition = j, g.angle = 0) : (g.type = "gradient", g.angle = (270 - k) % 360), a.appendChild(g)
						}
						return 1
					},
					B = function (a, b) {
					...
					C = c.el;
				B.prototype = C, C.constructor = B, C.transform = function (a) {
					if (null == a) return this._.transform;
					var d, e = this.paper._viewBoxShift,
						f = e ? "s" + [e.scale, e.scale] + "-1-1t" + [e.dx, e.dy] : m;
					e && (d = a = b(a).replace(/\.{3}|\u2026/g, this._.transform || m)), c._extractTransform(this, f + a);
					...
					if (h.translate(1, 1), n || k || "image" == this.type)
						...
						} else j.style.filter = m, x(this, g.scalex, g.scaley, g.dx, g.dy, g.rotate);
					else j.style.filter = m, i.matrix = b(h), i.offset = h.offset();
					...
					return this.removed ? this : (a = b(a).split(j), a.length - 1 && (c = d(a[1])), a = d(a[0]) || 0, c = +c || 0, this._.bbox && (this._.bbox.x += a, this._.bbox.y += c), this.transform(this._.transform.concat([["t", a, c]])), this)
				}, C.scale = function (a, c, e, f) {
					if (this.removed) return this;
					if (a = b(a).split(j), a.length - 1 && (c = d(a[1]), e = d(a[2]), f = d(a[3]), isNaN(e) && (e = null), isNaN(f) && (f = null)), a = d(a[0]), null == c && (c = a), null == f && (e = f), null == e || null == f) var g = this.getBBox(1);
				...
				}, C.auxGetBBox = c.el.getBBox, C.getBBox = function () {
					...
					var m;
					null != d && (m = {}, m[b] = d), null == d && c.is(b, "object") && (m = b);
					for (var n in m) k("raphael.attr." + n + "." + this.id, this, m[n]);
					if (m) {
						for (n in this.paper.customAttributes)
							if (this.paper.customAttributes[a](n) && m[a](n) && c.is(this.paper.customAttributes[n], "function")) {
						...
						m.text && "text" == this.type && (this.textpath.string = m.text), z(this, m)
					}
					return this
				}, C.toFront = function () {
					...
					var b = this.node.runtimeStyle,
						d = b.filter;
					return d = d.replace(p, m), 0 != +a ? (this.attrs.blur = a, b.filter = d + l + " progid:DXImageTransform.Microsoft.Blur(pixelradius=" + (+a || 1.5) + ")", b.margin = c.format("-{0}px 0 0 -{0}px", f(+a || 1.5))) : (b.filter = d, b.margin = 0, delete this.attrs.blur), this
				}, c._engine.path = function (a, b) {
					var c = D("shape");
					c.style.cssText = r, c.coordsize = s + l + s, c.coordorigin = b.coordorigin;
					var d = new B(c, b),
						e = {
							fill: "none",
							stroke: "#000"
						};
					a && (e.path = a), d.type = "path", d.path = [], d.Path = m, z(d, e), b.canvas.appendChild(c);
					var f = D("skew");
					return f.on = !0, c.appendChild(f), d.skew = f, d.transform(m), d
					...
					var f = a.path();
					f.attrs;
					return f.X = b - d, f.Y = c - e, f.W = 2 * d, f.H = 2 * e, f.type = "ellipse", z(f, {
						cx: b,
						cy: c,
						rx: d,
						ry: e
					...
					var e = a.path();
					e.attrs;
					return e.X = b - d, e.Y = c - d, e.W = e.H = 2 * d, e.type = "circle", z(e, {
						cx: b,
						cy: c,
						r: d
					}), e
					...
					return j.src = b, i.X = j.x = d, i.Y = j.y = e, i.W = j.width = f, i.H = j.height = g, j.path = h, i.type = "image", l.parentNode == k && k.removeChild(l), l.rotate = !0, l.src = b, l.type = "tile", i._.fillpos = [d, e], i._.fillsize = [f, g], k.appendChild(l), x(i, 1, 1, 0, 0, 0), i
				}, c._engine.text = function (a, d, e, g) {
					var h = D("shape"),
						i = D("path"),
						j = D("textpath");
					d = d || 0, e = e || 0, g = g || "", i.v = c.format("m{0},{1}l{2},{1}", f(d * s), f(e * s), f(d * s) + 1), i.textpathok = !0, j.string = b(g), j.on = !0, h.style.cssText = r, h.coordsize = s + l + s, h.coordorigin = "0 0";
					var k = new B(h, a),
						n = {
							fill: "#000",
							stroke: "none",
					...
					k.shape = h, k.path = i, k.textpath = j, k.type = "text", k.attrs.text = b(g), k.attrs.x = d, k.attrs.y = e, k.attrs.w = 1, k.attrs.h = 1, z(k, n), h.appendChild(j), h.appendChild(i), a.canvas.appendChild(h);
					var o = D("skew");
					return o.on = !0, h.appendChild(o), k.skew = o, k.transform(m), k
				}, c._engine.setSize = function (a, b) {
					...
					var g, h, i = this.getSize(),
						j = i.width,
						k = i.height;
					return f && (g = k / e, h = j / d, d * g < j && (a -= (j - d * g) / 2 / g), e * h < k && (b -= (k - e * h) / 2 / h)), this._viewBox = [a, b, d, e, !!f], this._viewBoxShift = {
						dx: -a,
						dy: -b,
						scale: i
				...
				c._engine.initWin = function (a) {
					...
					try {
						!b.namespaces.rvml && b.namespaces.add("rvml", "urn:schemas-microsoft-com:vml"), D = function (a) {
					...
					var h = new c._Paper,
						...
						j = i.style;
					return f = f || 0, g = g || 0, e = e || 512, d = d || 342, h.width = e, h.height = d, e == +e && (e += "px"), d == +d && (d += "px"), h.coordsize = 216e5 + l + 216e5, h.coordorigin = "0 0", h.span = c._g.doc.createElement("span"), h.span.style.cssText = "position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;", i.appendChild(h.span), j.cssText = c.format("top:0;left:0;width:{0};height:{1};display:inline-block;position:relative;clip:rect(0 {0} {1} 0);overflow:hidden", e, d), 1 == b ? (c._g.doc.body.appendChild(i), j.left = f + "px", j.top = g + "px", j.position = "absolute") : b.firstChild ? b.insertBefore(i, b.firstChild) : b.appendChild(i), h.renderfix = function () {}, h
				}, c.prototype.clear = function () {
					c.eve("raphael.clear", this), this.canvas.innerHTML = m, this.span = c._g.doc.createElement("span"), this.span.style.cssText = "position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;display:inline;", this.canvas.appendChild(this.span), this.bottom = this.top = null
				}, c.prototype.remove = function () {
				...
				var E = c.st;
				for (var F in C) C[a](F) && !E[a](F) && (E[F] = function (a) {
					return function () {
						var b = arguments;
						return this.forEach(function (c) {
							c[a].apply(c, b)
	...
	b = window.Morris = {}, a = jQuery, b.EventEmitter = function () {
		...
		return h(d, c), d.prototype.gridDefaults = {
			...
			if (s = this.cumulative ? 0 : null, t = this.cumulative ? 0 : null, this.options.goals.length > 0 && (k = Math.min.apply(Math, this.options.goals), j = Math.max.apply(Math, this.options.goals), t = null != t ? Math.min(t, k) : k, s = null != s ? Math.max(s, j) : j), this.data = function () {
					var a, d, e;
					for (e = [], i = a = 0, d = c.length; a < d; i = ++a) m = c[i], l = {
						src: m
					}, l.label = m[this.options.xkey], this.options.parseTime ? (l.x = b.parseDate(l.label), this.options.dateFormat ? l.label = this.options.dateFormat(l.x) : "number" == typeof l.label && (l.label = new Date(l.label).toString())) : (l.x = i,
						this.options.xLabelFormat && (l.label = this.options.xLabelFormat(l))), p = 0, l.y = function () {
						var a, b, c, d;
						for (c = this.options.ykeys, d = [], h = a = 0, b = c.length; a < b; h = ++a) r = c[h], u = m[r], "string" == typeof u && (u = parseFloat(u)), null != u && "number" != typeof u && (u = null), null != u && this.hasToShow(h) && (this.cumulative ? p += u : null != s ? (s = Math.max(u, s), t = Math.min(u, t)) : s = t = u), this.cumulative && null != p && (s = Math.max(p, s), t = Math.min(p, t)), d.push(u);
						return d
					}.call(this), e.push(l);
					return e
				...
				if (this.options.parseTime)
					for (x = this.options.events, v = 0, w = x.length; v < w; v++) e = x[v], e instanceof Array ? (g = e[0], o = e[1], this.events.push([b.parseDate(g), b.parseDate(o)])) : this.events.push(b.parseDate(e));
			...
			return this.xmin === this.xmax && (this.xmin -= 1, this.xmax += 1), this.ymin = this.yboundary("min", t), this.ymax = this.yboundary("max", s), this.ymin === this.ymax && (t && (this.ymin -= 1), this.ymax += 1), !0 !== (y = this.options.axes) && "both" !== y && "y" !== y && !0 !== this.options.grid || (this.options.ymax === this.gridDefaults.ymax && this.options.ymin === this.gridDefaults.ymin ? (this.grid = this.autoGridLines(this.ymin, this.ymax, this.options.numLines), this.ymin = Math.min(this.ymin, this.grid[0]), this.ymax = Math.max(this.ymax, this.grid[this.grid.length - 1])) : (n = (this.ymax - this.ymin) / (this.options.numLines - 1), this.grid = function () {
				var a, b, c;
				for (c = [], q = a = this.ymin, b = this.ymax; n > 0 ? a <= b : a >= b; q = a += n) c.push(q);
				return c
			...
			if (f = this.el.width(), d = this.el.height(), (this.elementWidth !== f || this.elementHeight !== d || this.dirty) && (this.elementWidth = f, this.elementHeight = d, this.dirty = !1, this.left = this.options.padding, this.right = this.elementWidth - this.options.padding, this.top = this.options.padding, this.bottom = this.elementHeight - this.options.padding, !0 !== (h = this.options.axes) && "both" !== h && "y" !== h || (g = function () {
					var a, b, d, e;
					for (d = this.grid, e = [], a = 0, b = d.length; a < b; a++) c = d[a], e.push(this.measureText(this.yAxisFormat(c)).width);
					return e
				}.call(this), this.options.horizontal ? this.bottom -= Math.max.apply(Math, g) : this.left += Math.max.apply(Math, g)), !0 !== (i = this.options.axes) && "both" !== i && "x" !== i || (a = this.options.horizontal ? -90 : -this.options.xLabelAngle, b = function () {
					var b, c, d;
					for (d = [], e = b = 0, c = this.data.length; 0 <= c ? b < c : b > c; e = 0 <= c ? ++b : --b) d.push(this.measureText(this.data[e].label, a).height);
					return d
				}.call(this), this.options.horizontal ? this.left += Math.max.apply(Math, b) : this.bottom -= Math.max.apply(Math, b)), this.width = Math.max(1, this.right - this.left), this.height = Math.max(1, this.bottom - this.top), this.options.horizontal ? (this.dx = this.height / (this.xmax - this.xmin), this.dy = this.width / (this.ymax - this.ymin), this.yStart = this.left, this.yEnd = this.right, this.xStart = this.top, this.xEnd = this.bottom, this.xSize = this.height, this.ySize = this.width) : (this.dx = this.width / (this.xmax - this.xmin), this.dy = this.height / (this.ymax - this.ymin), this.yStart = this.bottom, this.yEnd = this.top, this.xStart = this.left, this.xEnd = this.right, this.xSize = this.width, this.ySize = this.height), this.calc)) return this.calc()
			...
			var a, b, c, d, e, f, g, h, i;
			if (!1 !== this.options.grid || !0 === (f = this.options.axes) || "both" === f || "y" === f) {
				for (a = this.options.horizontal ? this.getXAxisLabelY() : this.getYAxisLabelX(), g = this.grid, i = [], d = 0, e = g.length; d < e; d++) b = g[d], c = this.transY(b), !0 !== (h = this.options.axes) && "both" !== h && "y" !== h || (this.options.horizontal ? this.drawXAxisLabel(c, a, this.yAxisFormat(b)) : this.drawYAxisLabel(a, c, this.yAxisFormat(b))), this.options.grid ? (c = Math.floor(c) + .5, this.options.horizontal ? i.push(this.drawGridLine("M" + c + "," + this.xStart + "V" + this.xEnd)) : i.push(this.drawGridLine("M" + this.xStart + "," + c + "H" + this.xEnd))) : i.push(void 0);
				return i
			}
		...
		return c.defaults = {
			...
			var d, e, f, g, h, i;
			return h = this.options.parent.innerWidth(), g = this.options.parent.innerHeight(), e = this.el.outerWidth(), d = this.el.outerHeight(), f = Math.min(Math.max(0, a - e / 2), h - e), null != b ? !0 === c ? (i = b - d / 2) < 0 && (i = 0) : (i = b - d - 10) < 0 && (i = b + 10) + d > g && (i = g / 2 - d / 2) : i = g / 2 - d / 2, this.el.css({
				left: f + "px",
				top: parseInt(i) + "px"
			})
		...
		return h(d, c), d.prototype.init = function () {
			...
			var c, d, e, f, g, h, i;
			for (e = this.data[b], c = a("<div class='morris-hover-row-label'>").text(e.label), c = c.prop("outerHTML"), i = e.y, d = g = 0, h = i.length; g < h; d = ++g) f = i[d], !1 !== this.options.labels[d] && (c += "<div class='morris-hover-point' style='color: " + this.colorFor(e, d, "label") + "'>\n  " + this.options.labels[d] + ":\n  " + this.yLabelFormat(f, d) + "\n</div>");
			...
			var a, b, c, d, e, f;
			for (this.seriesPoints = [], a = b = d = this.options.ykeys.length - 1; d <= 0 ? b <= 0 : b >= 0; a = d <= 0 ? ++b : --b) this.hasToShow(a) && ((!1 !== this.options.trendLine && !0 === this.options.trendLine || !0 === this.options.trendLine[a]) && this._drawTrendLine(a), this._drawLineFor(a));
			for (f = [], a = c = e = this.options.ykeys.length - 1; e <= 0 ? c <= 0 : c >= 0; a = e <= 0 ? ++c : --c) this.hasToShow(a) ? f.push(this._drawPointFor(a)) : f.push(void 0);
			return f
			...
			for (h = 0, k = 0, i = 0, j = 0, f = 0, q = this.data, o = 0, p = q.length; o < p; o++) l = q[o], m = l.x, void 0 !== (n = l.y[a]) && (f += 1, h += m, k += n, i += m * m, j += m * n);
			...
			if (0 !== this.pointSizeForSeries(a)) return Raphael.animation({
		...
		return h(d, c), d.prototype.init = function () {
			...
			var a, b, c, d, e, f, g;
			for (f = this.data, g = [], a = d = 0, e = f.length; d < e; a = ++d) b = f[a], b._x = this.xStart + this.xSize * (a + .5) / this.data.length, g.push(b._y = function () {
				var a, d, e, f;
			...
			if (c = this.xSize / this.options.data.length, this.options.stacked) i = 1;
				...
				for (i = 0, d = q = 0, r = this.options.ykeys.length - 1; 0 <= r ? q <= r : q >= r; d = 0 <= r ? ++q : --q) this.hasToShow(d) && (i += 1);
			...
			var c, d, e, f, g, h, i, j;
			for (e = this.data[b], c = a("<div class='morris-hover-row-label'>").text(e.label), c = c.prop("outerHTML"), j = e.y, d = h = 0, i = j.length; h < i; d = ++h) g = j[d], !1 !== this.options.labels[d] && (c += "<div class='morris-hover-point' style='color: " + this.colorFor(e, d, "label") + "'>\n  " + this.options.labels[d] + ":\n  " + this.yLabelFormat(g, d) + "\n</div>");
